...
local altar = Altar.new(component[Redstone.entityType].address, component[Redstone.entityType].address,
                        component[Matrix.entityType].address, component[MeInterface.entityType].address,
